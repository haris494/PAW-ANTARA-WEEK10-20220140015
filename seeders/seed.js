      ...
      await Product.bulkCreate([
        {
          ...
          description:
            'Kaos polos bahan cotton combed 30s, adem, cocok buat sehari-hari',
          price: 75000,
          stock: 50,
        },
        {
          ...
          description:
            'Kemeja flanel lengan panjang, motif kotak-kotak, bahan tebal',
          price: 150000,
          stock: 20,
        },
        {
          ...
          description:
            'Celana chino warna khaki, potongan slim fit, bahan stretch nyaman dipake',
          price: 180000,
          stock: 15,
        },
        {
          ...
          description:
            'Sepatu sneakers bahan canvas, cocok buat kasual, tersedia banyak ukuran',
          price: 220000,
          stock: 30,
        },
      ]);
